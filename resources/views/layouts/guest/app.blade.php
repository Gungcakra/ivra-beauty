...
<body>
    ...
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/swiper.min.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/bootstrap.min.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/jquery.min.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/magnific-popup.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/odometer.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/nice-select2.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/glightbox.min.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/email.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/gsap.min.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/plugins/scrollTrigger.min.js')}}"></script>
    <script data-navigated-once src="{{  asset('guest/assets/js/app.js')}}"></script>
