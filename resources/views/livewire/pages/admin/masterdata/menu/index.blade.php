                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3 w-100" wire:click="delete({{ $menu->id }})">Delete</a>
                                        </div>
                                        <a class="menu-link px-3 w-100" wire:click="create({{ $menu->id }})">Add SubMenu</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3 w-100" wire:click="edit({{ $submenu->id }})">Edit</a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3 w-100" wire:click="delete({{ $submenu->id }})">Delete</a>
                                        </div>
                                    </div>
                                </td>
                                <td>— {{ $submenu->name }}</td>
