<div class="d-flex flex-column flex-column-fluid">
    <x-slot:title>Ivra Beauty - Masterdata Layanan</x-slot:title>
    <!--begin::Toolbar-->
                    ...
                    <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5">
                        ...
                        <tbody>
                            @if (count($data) < 1) <tr>
                                ...
                                <tr wire:key="layanan-{{ $layanan->id }}">
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.layanan.edit', $layanan->id) }}" class="menu-link px-3 w-100 bg-warning text-dark">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 w-100 bg-danger text-white" wire:click="delete({{ $layanan->id }})">Delete</a>
                                            </div>
                                        </div>
                                        <!--end::Menu item-->
                                    </td>
