...
<div class="modal fade" tabindex="-1" id="permissionModal" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">{{$permission_id ? 'Edit' : 'Add'}} Permission</h3>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" wire:click="{{ isset($permission_id) ? 'updatePermission' : 'storePermission' }}" >{{ $permission_id ? 'Update' : 'Store' }}</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" wire:click="assignPermissionsToRole">{{ $permission_id ? 'Update' : 'Store' }}</button>
