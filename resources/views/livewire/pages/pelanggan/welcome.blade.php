...
<body>
    ...
    <header class="mobile-menu d-lg-none mini-scrollbar">
        <div class="container g-0 g-lg-1">
            <nav id="navbar-menu-mobile" class="px-2 px-lg-0">
                ...
                <ul class="mb-0 menu">
                    <li class="submenu">
                        ...
                        <ul class="submenu-dropdown">
                            ...
                            <li><a href="home-four.html">Home 4</a></li>
                            <li><a href="home-five.html">Home 5</a></li>
                            <li><a href="home-six.html">Home 6</a></li>
                            <li><a href="home-seven.html">Home 7</a></li>
                            <li><a href="home-eight.html">Home 8</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul class="submenu-dropdown">
                            ...
                            <li><a href="services-two.html">Services 2</a></li>
                            <li><a href="services-three.html">Services 3</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul class="submenu-dropdown">
                            ...
                            <li><a href="billing.html">Billling</a></li>
                    ...
                    <li class="submenu">
                        <span>Pages</span>
                        <ul class="submenu-dropdown">
                            <li><a href="pricing-one.html">Pricing 1</a></li>
                            <li><a href="pricing-two.html">Pricing 2</a></li>
                            <li><a href="gallery-one.html">Gallery 1</a></li>
                            <li><a href="gallery-two.html">Gallery 2</a></li>
                            <li><a href="gallery-three.html">Gallery 3</a></li>
                            <li><a href="gallery-four.html">Gallery 4</a></li>
                ...
                <a href="services.html" class="primary-btn max-w-full w-100">Book Now</a>
            </nav>
        </div>
    </header>
        ...
        <div class="g-0 g-lg-1">
            <nav id="navbar-menu" class="d-flex justify-content-between align-items-center position-relative nav-menu-area">
                ...
                <ul class="mb-0 menu d-none d-lg-flex mini-scrollbar">
                    <li class="submenu mega-sub-menu">
                        <span>Home</span>
                        <ul class="submenu-dropdown mega-sub-menu-dropdown">
                            <li>
                                <a href="index.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-1.webp') }}" width="215" height="172" alt="" />
                                        </div>
                            ...
                            <li>
                                <a href="home-two.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-2.webp') }}" width="215" height="172" alt="" />
                                        </div>
                                        <span>Hairdrsser</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="home-three.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-3.webp') }}" width="215" height="172" alt="" />
                                        </div>
                            ...
                            <li>
                                <a href="home-four.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-4.webp') }}" width="215" height="172" alt="" />
                                        </div>
                                        <span>Beauty Artist</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="home-five.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-5.webp') }}" width="215" height="172" alt="" />
                                        </div>
                                        <span>Spa Salon</span>
                                    </div>
                                </a>
                            ...
                            <li>
                                <a href="home-six.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-6.webp')}}" width="215" height="172" alt="" />
                                        </div>
                            ...
                            <li>
                                <a href="home-seven.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-7.webp') }}" width="215" height="172" alt="" />
                                        </div>
                            ...
                            <li>
                                <a href="home-eight.html">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="">
                                            <img src="{{  asset('guest/assets/images/menu-home-img-8.webp')}}" width="215" height="172" alt="" />
                                        </div>
                    ...
                    <li>
                        <a class="d-flex align-items-center" href="about-us.html">About Us</a>
                    </li>
                    <li class="submenu">
                        <span>Services</span>
                        <ul class="submenu-dropdown">
                ...
                <div class="d-flex align-items-center gap-1 gap-sm-2 gap-md-3">
                    ...
                    <a href="contact-us.html" class="primary-btn d-none d-lg-block playFairFont">Book Now </a>
    ...
    <div class="left-sidebar" tabindex="-1">
        <div class="offcanvas-body d-flex flex-column align-items-center text-center">
            ...
            <img src="{{  asset('guest/assets/images/logo.png')}}" alt="" />
            <p class="text-white">Ivira Beauty is a conceptual name chosen for a modern and stylish Hair Salons and Hairdressers Website.</p>
