            ...
            <div class="col-lg-10 col-xl-9 col-xxl-8">
                <div class="reveal reveal--left reveal--overlay">
                    <div class="testimonial-inner">
                        <span class="sub-heading fade_up_anim">Apa Kata Pelanggan Kami</span>
                        <h2 class="fade_up_anim text-uppercase">Cerita Kepuasan Pelanggan</h2>
                        <p class="mb-4 mb-lg-5 pb-lg-2 fade_up_anim" data-delay=".3">
                            Kami berkomitmen memberikan pelayanan terbaik dan pengalaman yang berkesan. Berikut pendapat pelanggan yang telah mempercayakan perawatan mereka kepada kami.
                        </p>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-card">
                                        ...
                                        <p class="mt-3 pb-2 mb-3 mb-lg-4">
                                            Pelayanan yang sangat memuaskan dengan hasil yang rapi dan profesional. Stafnya ramah dan membuat saya merasa nyaman selama perawatan.
                                        </p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card">
                                        ...
                                        <p class="mt-3 pb-2 mb-3 mb-lg-4">
                                            Hasil perawatan yang luar biasa dengan harga yang terjangkau. Saya sangat puas dan akan merekomendasikan ke teman-teman saya.
                                        </p>
                                        <div class="d-flex gap-3 align-items-center">
                                            <img width="60" height="60" src="{{  asset('guest/assets/images/client-1.png')}}" alt="" />
                                            <div>
