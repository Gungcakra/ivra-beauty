...
{
    public $roles, $permissions, $name, $permissionName, $selectedRole, $selectedPermissions = [], $roleId, $idRoleToDelete, $permission_id, $roleWithPermissions, $search = '';
    ...
    public function storePermission()
    {
        ...
        // $latestpermission_id = Permission::latest()->first()->id;
        // $role = Role::find($this->roleId);
        // if ($role) {
        //     $role->givePermissionTo($latestpermission_id);
        // } else {
        //     $this->dispatch('error', 'Role not found');
        // }
    ...
    public function updatePermission()
    {
        try{
            $this->validate([
                'permissionName' => 'required|unique:permissions,name,' . $this->permission_id,
            ]);
        } catch (\Illuminate\Validation\ValidationException $e) {
            $this->dispatch('error', collect($e->errors())->flatten()->first());
            return;
    ...
    public function assignPermissionToRole($roleId, $permission_id)
    {
